...
export const AboutUs = () => {
    return (
        <div id="tokenomics" className="bg-gradient-to-b from-[#000000] to-[#1E1E1E] min-h-screen w-full py-24 px-16 text-white">
            ...
            <div className="mt-12">
                <div className="flex items-center gap-4">
                    <div className="bg-[#161616] border border-[#333333] rounded-xl w-1/4 h-[496px] px-7 py-14 flex flex-col items-center gap-8">
                    ...
                    <div className="bg-[#161616] border border-[#333333] rounded-xl w-1/2 h-[496px] px-7 py-10 flex flex-col items-center gap-8">
                        <div className="flex flex-col gap-2">
                    ...
                    <div className="bg-[#161616] border border-[#333333] rounded-xl w-1/4 h-[496px] px-7 py-10 flex flex-col items-center gap-8">
                ...
                <div className="flex items-center gap-4 mt-4">
                    <div className="bg-[#161616] border border-[#333333] rounded-xl w-1/2 h-[496px] px-7 py-14 flex flex-col justify-between gap-16">
                        <div className="flex flex-col gap-4">
                            <h1 className={`${dmSans.className} font-normal text-5xl`}>Total Supply</h1>
                            <p className={`${interSans.className} font-normal text-xl`}>VES serves as the backbone of the Vestion ecosystem. Designed as a <span className="text-[#E4B325]">growth-oriented token</span>, its value appreciates as Vestion’s adoption and success expand globally</p>
                        </div>
                        <div className="flex flex-col">
                    ...
                    <div className="bg-[#161616] border border-[#333333] rounded-xl w-1/2 h-[496px] px-7 py-14 flex flex-col gap-16">
                        <div className="flex flex-col gap-4">
                            <h1 className={`${dmSans.className} font-normal text-5xl leading-[4vw]`}>Vestion is Your Gateway to Financial Synergy</h1>
